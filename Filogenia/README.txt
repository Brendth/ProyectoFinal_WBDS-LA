...
1) MAFFT-SerralysinFilogenia.fasta: Alineamiento múltiple de las 21 secuencias de serralisinas, 5 de ellas del genoma analizado de "Serratia marcescens".
2) ModelTest_Serralysins.out: Salida del análisis con ModelTest-NG.
3) BeautiSerralysins.xml: Archivo de entrada para el análisis filogenético creado en el módulo beauti.
